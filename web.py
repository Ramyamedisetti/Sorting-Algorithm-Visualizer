...
def StartAlgorithm():
     ...
     elif(algo_menu.get()=='BubbleSort'):
        bubble_sort(data,drawData,speedscale.get())
     elif(algo_menu.get()=='MergeSort'):
        merge_sort(data,drawData,speedscale.get())
     elif(algo_menu.get()=='InsertionSort'):
        insertion_sort(data,drawData,speedscale.get())
     elif(algo_menu.get()=='SelectionSort'):
...
def Generate():
     global data
     print("Selected Algotithm: ",selected_algorithm.get())
...
algo_menu=ttk.Combobox(root,width=15,font=("new roman",19,"italic bold"),
textvariable=selected_algorithm,values=['BubbleSort','MergeSort','QuickSort','InsertionSort','SelectionSort'])
algo_menu.place(x=143,y=0)
algo_menu.current(0)



random_generate=Button(root,text="Generate",bg="#2DAE9A",font=("arial",12,"italic bold"),
relief=SUNKEN,activebackground="#059498",activeforeground="white",bd=5,width=10,command=Generate)
random_generate.place(x=750,y=60)
sizevaluelabel=Label(root,text="size:",font=("new roman",12,"italic bold"),bg="#0E6DA5",width=10,
fg="black",height=2,relief= GROOVE,bd=5)
sizevaluelabel.place(x=0,y=60)
sizevalue=Scale(root,from_=0,to_=30,resolution=1,orient=HORIZONTAL,font=("arial",14,"italic bold"),
relief=GROOVE,bd=2,width=10)
sizevalue.place(x=120,y=60)



minvaluelabel=Label(root,text="Min Value:",font=("new roman",12,"italic bold"),bg="#0E6DA5",width=10,
fg="black",height=2,relief=GROOVE,bd=5)
...
maxvaluelabel=Label(root,text="Max Value:",font=("new roman",12,"italic bold"),bg="#0E6DA5",width=10,
fg="black",height=2,relief=GROOVE,bd=5)
...
relief=SUNKEN,activebackground="#059498",activeforeground="white",bd=5,width=10,command=StartAlgorithm)
start.place(x=750,y=0)

speedlabel=Label(root,text="Speed:",font=("new roman",12,"italic bold"),bg="#0E6DA5",width=10,
